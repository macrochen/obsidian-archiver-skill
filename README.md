...
Archive articles (WeChat, Xiaohongshu) to Obsidian vault. Use when converting online articles into Obsidian-formatted notes with appropriate frontmatter, tags, and structure.
...
```bash
gemini skills install ./obsidian-archiver-skill
```
